...
const LoginFormContainer = () => {
        ...
        if (postLoginApi.data !== null) {
            {
                ...
                dispatch(setSystemAdminStatus(postLoginApi.data["role"] == SYSTEM_ADMIN_ROLE));
                localStorage.setItem("isSystemAdmin", (postLoginApi.data["role"] == SYSTEM_ADMIN_ROLE).toString());
    ...
    return (
        <LoginFormComponent onClickFunction={handleClick}/>
    );
};
